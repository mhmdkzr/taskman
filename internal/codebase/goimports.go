...
// GoImports fixes import blocks in every Go file in the module's own
// packages (see sourceFiles) — vendor/ is never touched, matching what go
// build/vet and every lint tool in this package already limit themselves to.
