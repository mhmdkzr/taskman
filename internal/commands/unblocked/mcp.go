...
// RegisterMCP adds the "task_unblocked" tool to server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_unblocked",
		Description:  "Resume a blocked task, optionally granting more auto-fix rounds.",
