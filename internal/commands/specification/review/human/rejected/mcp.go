...
// RegisterMCP adds the "task_specification_review_human_rejected" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_specification_review_human_rejected",
		Description:  "Report a task's specification's human review as rejected.",
