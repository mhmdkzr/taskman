...
// RegisterMCP adds the "task_specification_review_agent_rejected" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_specification_review_agent_rejected",
		Description:  "Report a task's specification's automated review as rejected, with findings.",
