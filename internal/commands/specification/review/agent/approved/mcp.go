...
// RegisterMCP adds the "task_specification_review_agent_approved" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_specification_review_agent_approved",
		Description:  "Report a task's specification's automated review as approved.",
