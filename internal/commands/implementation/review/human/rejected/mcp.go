...
// RegisterMCP adds the "task_implementation_review_human_rejected" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_implementation_review_human_rejected",
		Description:  "Report a task's implementation's human review as rejected.",
