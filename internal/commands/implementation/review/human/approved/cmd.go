...
func Command() *cli.Command {
	return &cli.Command{
		Name:  "approved",
		Usage: "report a task's implementation's human review as approved",
		Flags: []cli.Flag{
			&cli.StringFlag{Name: "id", Required: true, Usage: "the task whose implementation's human review was approved"},
