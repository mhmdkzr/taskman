...
// RegisterMCP adds the "task_implementation_review_human_approved" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_implementation_review_human_approved",
		Description:  "Report a task's implementation's human review as approved.",
