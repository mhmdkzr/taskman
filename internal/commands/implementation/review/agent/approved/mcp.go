...
// RegisterMCP adds the "task_implementation_review_agent_approved" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_implementation_review_agent_approved",
		Description:  "Report a task's implementation's automated review as approved.",
