...
// RegisterMCP adds the "task_implementation_review_agent_rejected" tool to
// server.
...
func mcpTool() *mcp.Tool {
	return &mcp.Tool{
		Name:         "task_implementation_review_agent_rejected",
		Description:  "Report a task's implementation's automated review as rejected, with findings.",
