...
func Tools() tools.Registry {
	return tools.Registry{
		...
		noteswrite.Name:   noteswrite.Tool,
		notesdelete.Name:  notesdelete.Tool,
		notesedit.Name:    notesedit.Tool,
		noteslink.Name:    noteslink.Tool,
		noteslist.Name:    noteslist.Tool,
		notesread.Name:    notesread.Tool,
		notessearch.Name:  notessearch.Tool,
