...
const Name = "notes_link"
const Description = "Create or update a link between two existing notes by name."

type Input struct {
	From         string `json:"from" jsonschema:"description=Name of the first note."`
