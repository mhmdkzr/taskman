...
The tool result includes the complete submitted list. This lets session history render each `todowrite` call as a separate todo set, while the database retains only the latest active list for the session.
