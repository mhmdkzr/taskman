...
logic - validating and applying state transitions - lives in its own vertical slice package under
`internal/commands` (`internal/commands/create`,
...
flat approve/reject entries - never conflated with `Reviews`).
