...
**Note:** This is part of a series of documents that outline [Go Style](https://google.github.io/styleguide/go/index.html) at Google. This document is **[normative](https://google.github.io/styleguide/go/index.html#normative) and [canonical](https://google.github.io/styleguide/go/index.html#canonical)**. See [the overview](https://google.github.io/styleguide/go/index.html#about) for more information.
...
5.  **[Consistency](#consistency)**: The code is consistent with the broader Google codebase.
...
Repetitive code especially obscures the differences between each nearly-identical section, and requires a reader to visually compare similar lines of code to find the changes. [Table-driven testing](https://go.dev/wiki/TableDrivenTests) is a good example of a mechanism that can concisely factor out the common code from the important details of each repetition, but the choice of which pieces to include in the table will have an impact on how easy the table is to understand.
...
If code looks very similar to this but is subtly different, a reader may not notice the change. In cases like this, it is worth intentionally [“boosting”](https://google.github.io/styleguide/go/best-practices.html#signal-boost) the signal of the error check by adding a comment to call attention to it.
...
- Before an [indentation change](https://google.github.io/styleguide/go/decisions.html#indentation-confusion) (e.g., function declaration, conditional)
...
- Not feel [repetitive](https://google.github.io/styleguide/go/decisions.html#repetition) when they are used
- Take the context into consideration
- Not repeat concepts that are already clear

You can find more specific guidance on naming in [decisions](https://google.github.io/styleguide/go/decisions.html#naming).
